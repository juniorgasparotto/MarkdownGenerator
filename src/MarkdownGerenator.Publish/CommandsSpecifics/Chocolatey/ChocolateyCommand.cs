    ...
    public class ChocolateyCommand : Command
    {
        ...
        public void Build()
        {
            try
            {
                ...
                // file1: Modify
                var modify = new MarkdownGenerator.Publish.CommandsSpecifics.Chocolatey.Nuspec.tools_t4.chocolateybeforemodify
                {
                ...
                // file2: Install
                var install = new MarkdownGenerator.Publish.CommandsSpecifics.Chocolatey.Nuspec.tools_t4.chocolateyinstall
                {
                    Session = new Dictionary<string, object> { { "vars", vars } }
                };
                install.Initialize();
                ...
                // file3: Uninstall
                var uninstall = new MarkdownGenerator.Publish.CommandsSpecifics.Chocolatey.Nuspec.tools_t4.chocolateyuninstall
                {
                    Session = new Dictionary<string, object> { { "vars", vars } }
                };
                ...
                // file4: nuspec
                var nuspec = new MarkdownGenerator.Publish.CommandsSpecifics.Chocolatey.Nuspec.nuspec
                {
                    Session = new Dictionary<string, object> { { "vars", vars } }
                };
                nuspec.Initialize();
